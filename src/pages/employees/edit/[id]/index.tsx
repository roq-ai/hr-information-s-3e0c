      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="vacation_data" mb="4" isInvalid={!!formik.errors?.vacation_data}>
              <FormLabel>Vacation Data</FormLabel>
              <Input
                type="text"
                name="vacation_data"
                value={formik.values?.vacation_data}
                onChange={formik.handleChange}
              />
              {formik.errors.vacation_data && <FormErrorMessage>{formik.errors?.vacation_data}</FormErrorMessage>}
            </FormControl>
